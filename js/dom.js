...
export const draftPanelEl = document.getElementById("draft-panel");
export const draftTitleEl = document.getElementById("draft-title");
export const draftBudgetEl = document.getElementById("draft-budget");
export const draftPaletteEl = document.getElementById("draft-palette");
export const draftResetButton = document.getElementById("draft-reset");
export const draftSubmitButton = document.getElementById("draft-submit");
export const draftStatusEl = document.getElementById("draft-status");
